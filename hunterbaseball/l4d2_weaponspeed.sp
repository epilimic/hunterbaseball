...
public OnPluginStart()
{
	...
	WeaponSpeedEnabled = CreateConVar("l4d2_weaponspeed_everyone", "1", "<0|1> - Apply the Weapon Attack Speed Modifier on Everyone?", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	WeaponSpeedAmount = CreateConVar("l4d2_weaponspeed_amount", "2.0", "<1.0-2.0> - Weapon Attack Speed Modified Value", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 1.0, true, 2.0);
